...
project_path='/misc/scratch03/reco/bhattaga/data/i-vectors/dnn_projects/rsr/rnn-utt-lstm-large/'
...
network['lstm-forward'] = lasagne.layers.recurrent.LSTMLayer(network['drop1'],600, mask_input=network['mask'],
                          ...
                          grad_clipping=100., only_return_final=True)

network['lstm-backward'] = lasagne.layers.recurrent.LSTMLayer(network['drop1'],600, mask_input=network['mask'],
                           ingate=gate_parameters, forgetgate=gate_parameters, cell=cell_parameters, outgate=gate_parameters, 
                           grad_clipping=100., only_return_final=True, backwards=True)
